...
public class Table {
    ...
    private int widthAge = 13; // khởi tạo độ rộng của Age
    ...
    public void updateTemplate() {
        ...
        barLine = "+" + col1 + "+" + col2 + "+" + col3 + "+" + col4 + "+" + col5 + "+" + col5 + "+" + col5 + "+";
        template = "| %" + widthID + "s | %" + widthName + "s    | %" + widthAge + "s | %" + widthSalary + "s    | %" + widthLocation + "s | %" + widthLocation + "s | %" + widthLocation + "s |\n";
    }
}
