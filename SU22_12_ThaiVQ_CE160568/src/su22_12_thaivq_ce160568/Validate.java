    ...
    public String checkInputPhone() {
        ...
        while (true) {
            ...
            String regex = "^[(]?[0-9]{3}[)]?[-. ]?[0-9]{3}[-. ]?[0-9]{4}|"
                    + "[0-9]{3}[-][0-9]{3}[-][0-9]{4}$";
            String regex1 = "[0-9]{3}[-]{1}[0-9]{3}[-]{1}[0-9]{4}[ ]{1}[x]{1}[0-9]{4}";
            String regex2 = "[0-9]{3}[-]{1}[0-9]{3}[-]{1}[0-9]{4}[ ]{1}[e]{1}[x]{1}[t]{1}[0-9]{4}";
            if (result.isEmpty()) {
            ...
            if (!isVaild) { // nếu trả về false nghĩa là input đầu vào sai format thì thông báo
